          ...
          <div style="font-family: Arial, sans-serif; color: #333; background-color: #f7f7f7; padding: 20px;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
              ...
              <p style="text-align: center;">
                <a href="${env_config_1.envs.FRONTEND_URL}/auth/confirm-account/${parametros.token}" style="display: inline-block; padding: 10px 20px; color: #fff; background-color: #4CAF50; border-radius: 5px; text-decoration: none;">Confirmar Cuenta</a>
              </p>
              <p>O puedes copiar y pegar el siguiente enlace en tu navegador:</p>
              <p><a href="${env_config_1.envs.FRONTEND_URL}/auth/confirm-account/${parametros.token}" style="color: #4CAF50;">Click aca</a></p>
        ...
        const info = yield nodemailer_config_1.transport.sendMail({
          ...
          <div style="font-family: Arial, sans-serif; color: #333; background-color: #f7f7f7; padding: 20px;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
              ...
              <p>O puedes copiar y pegar el siguiente enlace en tu navegador:</p>
              <p><a href="${env_config_1.envs.FRONTEND_URL}/auth/reset-password/${parametros.token}" style="color: #4CAF50;">Click aca</a></p>
              <p style="color: #888;">Este token expira en 30 minutos.</p>

...
exports.hashAllPasswords = hashAllPasswords;
exports.assignSpecialtiesAndInterests = assignSpecialtiesAndInterests;
const bcrypt_config_1 = require("../utils/bcrypt/bcrypt.config");
// funcion para hashear las contraseñas
function hashAllPasswords(users) {
    return __awaiter(this, void 0, void 0, function* () {
        const updatedUsers = yield Promise.all(users.map((user) => __awaiter(this, void 0, void 0, function* () {
            const hashedPassword = yield (0, bcrypt_config_1.hashPassword)(user.password);
...
function assignSpecialtiesAndInterests(users, allSpecialties) {
    return users.map((user) => {
        ...
        const remainingSpecialties = shuffledSpecialties.filter((spec) => !specialties.some((s) => s.specialtyId === spec.specialtyId));
        const interests = remainingSpecialties.slice(0, numInterests);
        return Object.assign(Object.assign({}, user), { specialties,
            interests });
    });
}
...
exports.users = [
    {
        ...
        email: "catrielmilei@gmail.com",
        password: "Javier.milei777",
        aboutme: "I teach advanced reading and cat care. Looking to learn relaxation techniques and mindfulness.",
    ...
    },
    {
        ...
        email: "lorenzo.dominguez@gmail.com",
        password: "Javier.milei777",
        aboutme: "I teach hiking and route exploration. Interested in learning landscape photography.",
        avatar: "/JavierMilei.jpg",
        phoneNumber: "1234567892",
    },
    {
        ...
        email: "juliana.ortiz@gmail.com",
        password: "Javier.milei777",
        aboutme: "I teach international cuisine and want to learn foreign languages.",
        avatar: "/JavierMilei.jpg",
        phoneNumber: "1234567893",
    },
    {
    ...
    },
    {
        ...
        email: "victoria.martinez@gmail.com",
        password: "Javier.milei777",
        aboutme: "I teach yoga and meditation. Learning about nutrition and dietetics.",
        avatar: "/JavierMilei.jpg",
        phoneNumber: "1234567897",
    },
    {
    ...
    },
    {
        ...
        email: "joaquin.reyes@gmail.com",
        password: "Javier.milei777",
        aboutme: "I teach video games and eSports and want to learn game programming.",
        avatar: "/JavierMilei.jpg",
        phoneNumber: "2345678916",
    },
    {
        ...
        email: "paula.ruiz@gmail.com",
        password: "Javier.milei777",
        aboutme: "I teach fashion design and want to learn pattern making and sewing.",
        avatar: "/JavierMilei.jpg",
        phoneNumber: "2345678917",
    },
    {
        ...
        email: "bruno.delgado@gmail.com",
        password: "Javier.milei777",
        aboutme: "I teach hiking and camping and want to learn orientation and survival.",
        avatar: "/JavierMilei.jpg",
        phoneNumber: "2345678918",
    },
    {
        ...
        email: "lucia.hernandez@gmail.com",
        password: "Javier.milei777",
        aboutme: "I teach travel photography and want to learn cultural documentation.",
        avatar: "/JavierMilei.jpg",
        phoneNumber: "2345678919",
    },
    {
    ...
    },
    {
        ...
        email: "isabel.romero@gmail.com",
        password: "Javier.milei777",
        aboutme: "I teach home cooking and desserts and want to learn advanced baking.",
        avatar: "/JavierMilei.jpg",
        phoneNumber: "3456789129",
    },
    {
    ...
    },
    {
        ...
        password: "Javier.milei777",
        aboutme: "I teach Urban photography and want to learn Street art and graffiti.",
        avatar: "/JavierMilei.jpg",
        phoneNumber: "4567891234",
    },
    {
    ...
    },
    {
        ...
        password: "Javier.milei777",
        aboutme: "I teach Public speaking and debate and want to learn Public speeches.",
        avatar: "/JavierMilei.jpg",
    ...
    },
    {
        ...
        password: "Javier.milei777",
        aboutme: "I teach Climbing and mountaineering and want to learn Climbing techniques.",
        avatar: "/JavierMilei.jpg",
    ...
    },
    {
        ...
        password: "Javier.milei777",
        aboutme: "I teach Alternative medicine and want to learn Holistic therapies.",
        avatar: "/JavierMilei.jpg",
    ...
    },
    {
        ...
        password: "Javier.milei777",
        aboutme: "I teach Household economics and want to learn Investment and finance.",
        avatar: "/JavierMilei.jpg",
    ...
    },
    {
        ...
        password: "Javier.milei777",
        aboutme: "I teach International cuisine and want to learn Local gastronomy.",
        avatar: "/JavierMilei.jpg",
    ...
    },
    {
        ...
        password: "Javier.milei777",
        aboutme: "I teach Yoga and meditation and want to learn Relaxation techniques.",
        avatar: "/JavierMilei.jpg",
